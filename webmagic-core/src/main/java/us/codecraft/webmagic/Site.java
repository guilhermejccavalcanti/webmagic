...
public class Site {
  ...
  /**
     ...
     * @deprecated
     */
  @Deprecated public List<String> getStartUrls() {
  ...
  @Override public String toString() {
    return "Site{" + "domain=\'" + domain + '\'' + ", userAgent=\'" + userAgent + '\'' + ", cookies=" + defaultCookies + ", charset=\'" + charset + '\'' + ", startRequests=" + startRequests + ", sleepTime=" + sleepTime + ", retryTimes=" + retryTimes + ", cycleRetryTimes=" + cycleRetryTimes + ", timeOut=" + timeOut + ", acceptStatCode=" + acceptStatCode + ", headers=" + headers + '}';
  }
